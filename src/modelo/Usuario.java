...
public class Usuario {
    ...
    public Usuario(int idUsuario, String nombre, String email, String passwordHash, String rol) {
    ...
    // Constructor para Crear Nuevo Usuario (Registro)
